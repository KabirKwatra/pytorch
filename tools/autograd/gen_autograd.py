...
def load_aten_declarations(path):
    ...
    for declaration in declarations:
        ...
        declaration["formals"] = [
            arg["type"] + " " + arg["name"] for arg in declaration["arguments"]
        ]
        declaration["args"] = [arg["name"] for arg in declaration["arguments"]]
        declaration["type_method_formals"] = [
            arg["type"] + " " + arg["name"] for arg in declaration["arguments"]
        ]
        declaration["type_method_args"] = [
...
def gen_autograd(
    aten_path, out, autograd_dir, disable_autograd=False, disable_trace=False
):
...
def gen_autograd_python(aten_path, out, autograd_dir):
    ...
    gen_autograd_functions_python(out, autograd_functions, template_path)
