...
enum class DispatchKey : uint8_t {
  ...
  HIPTensorId, // NB: I think this is not actually used, due to Note
               // [Masquerading as CUDA]
  MSNPUTensorId, // unused externally, but tested at
  ...
  SparseHIPTensorId, // TODO: I think this is not actually used, due to Note
                     // [Masquerading as CUDA]
