...
#define GS(name) def(#name, &Graph ::name)
    ...
    .def(
        "createFusionGroup",
    [](Graph& g) {
        return g.createWithSubgraph(prim::FusionGroup);
    })
    .def(
        "createCudaFusionGroup",
    [](Graph& g) {
        return g.createWithSubgraph(prim::CudaFusionGroup);
    })
    .def(
        "createClone",
...
#undef VS
    ...
    .def("returnNode", [](Block& b) {
        return b.return_node();
    })
    .def("paramNode", [](Block& b) {
        return b.param_node();
    });
...
#undef CREATE_ACCESSOR
    ...
    .def("cconv", [](Node& n) {
        return n.expect<ConcretePythonOp>()->cconv;
    })
    .def("pyname", [](Node& n) {
        return n.expect<ConcretePythonOp>()->name();
    })
