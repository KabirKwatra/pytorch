...
TH_API void THTensor_(
    ltValueByte)(THByteTensor* r_, THTensor* t, scalar_t value);
TH_API void THTensor_(
    leValueByte)(THByteTensor* r_, THTensor* t, scalar_t value);
TH_API void THTensor_(
    gtValueByte)(THByteTensor* r_, THTensor* t, scalar_t value);
TH_API void THTensor_(
    geValueByte)(THByteTensor* r_, THTensor* t, scalar_t value);
TH_API void THTensor_(
    neValueByte)(THByteTensor* r_, THTensor* t, scalar_t value);
TH_API void THTensor_(
    eqValueByte)(THByteTensor* r_, THTensor* t, scalar_t value);

TH_API void THTensor_(
    ltTensorByte)(THByteTensor* r_, THTensor* ta, THTensor* tb);
TH_API void THTensor_(
    leTensorByte)(THByteTensor* r_, THTensor* ta, THTensor* tb);
TH_API void THTensor_(
    gtTensorByte)(THByteTensor* r_, THTensor* ta, THTensor* tb);
TH_API void THTensor_(
    geTensorByte)(THByteTensor* r_, THTensor* ta, THTensor* tb);
TH_API void THTensor_(
    neTensorByte)(THByteTensor* r_, THTensor* ta, THTensor* tb);
TH_API void THTensor_(
    eqTensorByte)(THByteTensor* r_, THTensor* ta, THTensor* tb);
...
TH_API void THTensor_(max)(
    THTensor* values_,
    THLongTensor* indices_,
    THTensor* t,
    int dimension,
    int keepdim);
TH_API void THTensor_(min)(
    THTensor* values_,
    THLongTensor* indices_,
    THTensor* t,
    int dimension,
...
TH_API void THTensor_(
    take)(THTensor* tensor, THTensor* src, THLongTensor* index);
TH_API void THTensor_(
...
TH_API void THTensor_(
    clamp)(THTensor* r_, THTensor* t, scalar_t min_value, scalar_t max_value);

TH_API void THTensor_(
    cadd)(THTensor* r_, THTensor* t, scalar_t value, THTensor* src);
TH_API void THTensor_(
    csub)(THTensor* self, THTensor* src1, scalar_t value, THTensor* src2);
...
TH_API void THTensor_(kthvalue)(
    THTensor* values_,
    THLongTensor* indices_,
    THTensor* t,
    int64_t k,
...
TH_API void THTensor_(norm)(
    THTensor* r_,
    THTensor* t,
    scalar_t value,
    int dimension,
    int keepdim);
TH_API void THTensor_(renorm)(
    THTensor* r_,
    THTensor* t,
    scalar_t value,
    int dimension,
