...
// and documentation alias these to the single THTensor type.
...
TH_API THTensor* THTensor_(newWithStorage1d)(
    THStorage* storage_,
...
TH_API THTensor* THTensor_(
    newWithSize3d)(int64_t size0_, int64_t size1_, int64_t size2_);
TH_API THTensor* THTensor_(newWithSize4d)(
    int64_t size0_,
    int64_t size1_,
    int64_t size2_,
    int64_t size3_);
...
TH_API THTensor* THTensor_(newNarrow)(
    THTensor* tensor,
    int dimension_,
    int64_t firstIndex_,
    int64_t size_);
...
TH_API void THTensor_(resizeNd)(
    THTensor* tensor,
    int nDimension,
    const int64_t* size,
...
TH_API void THTensor_(
    resize2d)(THTensor* tensor, int64_t size0_, int64_t size1_);
TH_API void THTensor_(
    resize3d)(THTensor* tensor, int64_t size0_, int64_t size1_, int64_t size2_);
TH_API void THTensor_(resize4d)(
    THTensor* tensor,
    int64_t size0_,
    int64_t size1_,
    int64_t size2_,
    int64_t size3_);
TH_API void THTensor_(resize5d)(
    THTensor* tensor,
    int64_t size0_,
    int64_t size1_,
    int64_t size2_,
    int64_t size3_,
    int64_t size4_);
// Note: these are legacy resize functions that treat sizes as size->size() == 0
// and size->data<int64_t>() as being 0-terminated.

TH_API void THTensor_(set)(THTensor* self, THTensor* src);
TH_API void THTensor_(setStorageNd)(
    THTensor* self,
    THStorage* storage_,
    ptrdiff_t storageOffset_,
    int nDimension,
...
TH_API void THTensor_(narrow)(
    ...
    int64_t size_);
TH_API void THTensor_(
    select)(THTensor* self, THTensor* src, int dimension_, int64_t sliceIndex_);
TH_API void THTensor_(
    transpose)(THTensor* self, THTensor* src, int dimension1_, int dimension2_);
...
TH_API void THTensor_(
    unsqueeze1d)(THTensor* self, THTensor* src, int dimension_);
...
TH_API void THTensor_(set3d)(
    THTensor* tensor,
    int64_t x0,
    int64_t x1,
    int64_t x2,
    scalar_t value);
TH_API void THTensor_(set4d)(
    THTensor* tensor,
    int64_t x0,
    int64_t x1,
    int64_t x2,
...
TH_API scalar_t
    THTensor_(get2d)(const THTensor* tensor, int64_t x0, int64_t x1);
TH_API scalar_t THTensor_(
    get3d)(const THTensor* tensor, int64_t x0, int64_t x1, int64_t x2);
TH_API scalar_t THTensor_(get4d)(
