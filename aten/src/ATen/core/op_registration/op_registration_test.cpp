...
TEST(
    ...
    whenRegisteringSameSchemaWithAliasAnalysisAfterRegisteringWithoutAliasAnalysis_thenCanBeCalled) {
  {
    auto registrar1 = c10::RegisterOperators().op(
        "_test::dummy(Tensor dummy) -> ()",
        c10::RegisterOperators::options().kernel<DummyKernel>(
            c10::DispatchKey::CPUTensorId));
    // NB: this is OK right now for BC reasons
    // expectThrows<c10::Error>([&] {
    auto registrar2 = c10::RegisterOperators().op(
        "_test::dummy(Tensor dummy) -> ()",
        c10::RegisterOperators::options()
            .kernel<DummyKernel>(c10::DispatchKey::XLATensorId)
            .aliasAnalysis(at::AliasAnalysisKind::PURE_FUNCTION));
    // }, "Tried to define the schema for _test::dummy multiple times without
    // providing an explicit alias analysis kind");
  }
}

TEST(
    OperatorRegistrationTest,
    whenRegisteringSameSchemaWithoutAliasAnalysisAfterRegisteringWithAliasAnalysis_thenCanBeCalled) {
  {
    auto registrar1 = c10::RegisterOperators().op(
        "_test::dummy(Tensor dummy) -> ()",
        c10::RegisterOperators::options()
...
TEST(
    OperatorRegistrationTest,
    whenRegisteringSameSchemaWithSameAliasAnalysis_thenCanBeCalled) {
  auto registrar1 = c10::RegisterOperators().op(
      "_test::dummy(Tensor dummy) -> ()",
      c10::RegisterOperators::options()
...
TEST(
    OperatorRegistrationTest,
    whenRegisteringSameSchemaWithNoAliasAnalysis_thenCanBeCalled) {
  auto registrar1 = c10::RegisterOperators().op(
      "_test::dummy(Tensor dummy) -> ()",
      c10::RegisterOperators::options().kernel<DummyKernel>(
          c10::DispatchKey::CPUTensorId));
...
TEST(
    OperatorRegistrationTest,
    whenRegisteringSameSchemaWithDifferentAliasAnalysis_thenShouldThrow) {
  auto registrar1 = c10::RegisterOperators().op(
      "_test::dummy(Tensor dummy) -> ()",
      c10::RegisterOperators::options()
          .kernel<DummyKernel>(c10::DispatchKey::CPUTensorId)
  ...
  expectThrows<c10::Error>(
      [] {
        auto registrar2 = c10::RegisterOperators().op(
            ...
            c10::RegisterOperators::options()
                .kernel<DummyKernel>(c10::DispatchKey::XLATensorId)
                .aliasAnalysis(at::AliasAnalysisKind::CONSERVATIVE));
      },
...
TEST(
  ...
  auto registrar = c10::RegisterOperators().op(
      c10::RegisterOperators::options()
          .schema("_test::dummy(Tensor dummy) -> ()")
...
TEST(
  ...
  bool called = false;
  auto registrar =
      c10::RegisterOperators().op(c10::RegisterOperators::options()
                                      .schema("_test::dummy")
                                      .catchAllKernel<MockKernel>(&called));
  ...
  expectThrows<c10::Error>(
      [] {
        c10::RegisterOperators().op(
            c10::RegisterOperators::options().catchAllKernel<DummyKernel>());
      },
...
TEST(
  ...
  auto registrar = c10::RegisterOperators().op(
      "_test::dummy(Tensor dummy) -> ()",
      c10::RegisterOperators::options().catchAllKernel<MockKernel>(&called));
...
// TEST(OperatorRegistrationTest,
// givenOpWithCatchallKernel_whenRegisteringDispatchedKernel_thenFails) {
//   bool called = false;
//   auto registrar = c10::RegisterOperators().op("_test::dummy(Tensor dummy) ->
//   ()",
//   c10::RegisterOperators::options().catchAllKernel<MockKernel>(&called));
//   expectThrows<c10::Error>([&] {
//     c10::RegisterOperators().op("_test::dummy(Tensor dummy) -> ()",
//     c10::RegisterOperators::options().kernel<MockKernel>(c10::DispatchKey::CPUTensorId,
//     &called));
//   }, "for an operator which already has a catch-all kernel registered");
// }

// TEST(OperatorRegistrationTest,
// givenOpWithCatchallKernel_whenRegisteringDispatchedKernelInSameOpCall_thenFails)
// {
//   bool called = false;
//   expectThrows<c10::Error>([&] {
//     auto registrar = c10::RegisterOperators().op("_test::dummy(Tensor dummy)
...
TEST(
  ...
  bool called = false;
  {
    auto registrar = c10::RegisterOperators().op(
        "_test::dummy(Tensor dummy) -> ()",
        c10::RegisterOperators::options().kernel<MockKernel>(
            c10::DispatchKey::CPUTensorId, &called));
  }
...
// TODO Rewrite (since this is now allowed) and reenable
// TEST(OperatorRegistrationTest,
// givenOpWithDispatchedKernel_whenRegisteringCatchallKernel_thenFails) {
//   bool called = false;
//   auto registrar = c10::RegisterOperators().op("_test::dummy(Tensor dummy) ->
//   ()",
//   c10::RegisterOperators::options().kernel<MockKernel>(c10::DispatchKey::CPUTensorId,
//   &called)); expectThrows<c10::Error>([&] {
//     c10::RegisterOperators().op("_test::dummy(Tensor dummy) -> ()",
//     c10::RegisterOperators::options().catchAllKernel<MockKernel>(&called));
//   }, "Tried to register a catch-all kernel for an operator which already has
//   kernels for dispatch keys CPUTensorId. An operator can only have either a
//   catch-all kernel or kernels with dispatch keys. The operator schema is
//   _test::dummy");
// }
//
// TEST(OperatorRegistrationTest,
// givenOpWithDispatchedKernel_whenRegisteringCatchallKernelInSameOpCall_thenFails)
// {
//   bool called = false;
//   expectThrows<c10::Error>([&] {
//     auto registrar = c10::RegisterOperators().op("_test::dummy(Tensor dummy)
...
TEST(
    OperatorRegistrationTest,
    givenOpWithoutKernels_whenRegisteringKernelAfterwards_thenCanBeCalled) {
  auto registrar1 =
      c10::RegisterOperators().op("_test::dummy(Tensor dummy) -> ()");
  ...
  auto registrar2 = c10::RegisterOperators().op(
      "_test::dummy(Tensor dummy) -> ()",
      c10::RegisterOperators::options().kernel<MockKernel>(
          c10::DispatchKey::CPUTensorId, &called_kernel));
...
TEST(
    OperatorRegistrationTest,
    givenOpWithoutKernels_whenRegisteringKernelAfterwardsWithDifferentSchema_thenFails) {
  auto registrar1 =
      c10::RegisterOperators().op("_test::dummy(Tensor dummy, int arg) -> ()");
...
TEST(
    OperatorRegistrationTest,
    givenOpWithoutKernels_whenRegisteringKernelAfterwardsAndRunsOutOfScope_thenSchemaIsStillThereButCannotBeCalledAnymore) {
  auto registrar1 =
      c10::RegisterOperators().op("_test::dummy(Tensor dummy) -> ()");
...
TEST(
  ...
  // as long as we don't register non-catchall kernels, ops without tensor
  // arguments are fine
...
TEST(
    OperatorRegistrationTest,
    givenMultipleKernelsWithSameDispatchKey_whenRegistering_thenShowsWarning) {
  auto registrar = c10::RegisterOperators().op(
      "_test::dummy(Tensor dummy) -> ()",
      c10::RegisterOperators::options().kernel<DummyKernel>(
          c10::DispatchKey::CPUTensorId));
  ...
  EXPECT_THAT(
      output,
      testing::HasSubstr(
          "overwrote a previously registered kernel with the same dispatch key for the same operator"));
}
...
TEST(
    OperatorRegistrationTest,
    givenMultipleKernelsWithSameDispatchKey_whenCalled_thenCallsNewerKernel) {
  bool called_kernel1 = false;
  bool called_kernel2 = false;
  auto registrar1 = c10::RegisterOperators().op(
      "_test::dummy(Tensor dummy) -> ()",
      c10::RegisterOperators::options().kernel<MockKernel>(
          c10::DispatchKey::CPUTensorId, &called_kernel1));
  auto registrar2 = c10::RegisterOperators().op(
      "_test::dummy(Tensor dummy) -> ()",
      c10::RegisterOperators::options().kernel<MockKernel>(
          c10::DispatchKey::CPUTensorId, &called_kernel2));
...
TEST(
    OperatorRegistrationTest,
    givenMultipleCatchallKernels_whenRegistering_thenShowsWarning) {
  auto registrar = c10::RegisterOperators().op(
      "_test::dummy(Tensor dummy) -> ()",
      c10::RegisterOperators::options().catchAllKernel<DummyKernel>());
...
TEST(
    OperatorRegistrationTest,
    givenMultipleCatchallKernels_whenCalled_thenCallsNewerKernel) {
  bool called_kernel1 = false;
  bool called_kernel2 = false;
  auto registrar1 = c10::RegisterOperators().op(
      "_test::dummy(Tensor dummy) -> ()",
      c10::RegisterOperators::options().catchAllKernel<MockKernel>(
          &called_kernel1));
  auto registrar2 = c10::RegisterOperators().op(
      "_test::dummy(Tensor dummy) -> ()",
      c10::RegisterOperators::options().catchAllKernel<MockKernel>(
...
TEST(
    OperatorRegistrationTest,
    givenMultipleKernelsWithSameDispatchKey_whenNewerKernelDeletedAndOpCalled_thenCallsOlderKernel) {
  bool called_kernel1 = false;
  bool called_kernel2 = false;
  auto registrar1 = c10::RegisterOperators().op(
      "_test::dummy(Tensor dummy) -> ()",
...
TEST(
    OperatorRegistrationTest,
    givenMultipleCatchallKernels_whenNewerKernelDeletedAndOpCalled_thenCallsOlderKernel) {
  bool called_kernel1 = false;
  bool called_kernel2 = false;
  auto registrar1 = c10::RegisterOperators().op(
      "_test::dummy(Tensor dummy) -> ()",
...
TEST(
    OperatorRegistrationTest,
    givenMultipleKernelsWithSameDispatchKey_whenOlderKernelDeletedAndOpCalled_thenCallsNewerKernel) {
  bool called_kernel1 = false;
  bool called_kernel2 = false;
  auto registrar1 = c10::RegisterOperators().op(
      "_test::dummy(Tensor dummy) -> ()",
...
TEST(
    OperatorRegistrationTest,
    givenMultipleCatchallKernels_whenOlderKernelDeletedAndOpCalled_thenCallsNewerKernel) {
  bool called_kernel1 = false;
  bool called_kernel2 = false;
  auto registrar1 = c10::RegisterOperators().op(
      "_test::dummy(Tensor dummy) -> ()",
...
TEST(
    OperatorRegistrationTest,
    givenMultipleKernelsWithSameDispatchKey_whenOlderAndThenNewerKernelDeletedAndOpCalled_thenFails) {
  bool called_kernel1 = false;
  bool called_kernel2 = false;
  auto registrar0 =
      c10::RegisterOperators().op("_test::dummy(Tensor dummy) -> ()");
...
TEST(
    OperatorRegistrationTest,
    givenMultipleCatchallKernels_whenOlderAndThenNewerKernelDeletedAndOpCalled_thenFails) {
  bool called_kernel1 = false;
  bool called_kernel2 = false;
  auto registrar0 =
      c10::RegisterOperators().op("_test::dummy(Tensor dummy) -> ()");
...
TEST(
    OperatorRegistrationTest,
    givenMultipleKernelsWithSameDispatchKey_whenNewerAndThenOlderKernelDeletedAndOpCalled_thenFails) {
  bool called_kernel1 = false;
  bool called_kernel2 = false;
  auto registrar0 =
      c10::RegisterOperators().op("_test::dummy(Tensor dummy) -> ()");
...
TEST(
    OperatorRegistrationTest,
    givenMultipleCatchallKernels_whenNewerAndThenOlderKernelDeletedAndOpCalled_thenFails) {
  bool called_kernel1 = false;
  bool called_kernel2 = false;
  auto registrar0 =
      c10::RegisterOperators().op("_test::dummy(Tensor dummy) -> ()");
...
TEST(
    OperatorRegistrationTest,
    whenRegisteringCPUTensorType_thenCanOnlyCallUnboxedWithCPUTensorIdDispatchKey) {
  bool called_kernel_cpu = false;
  auto registrar = c10::RegisterOperators().op(
      "_test::dummy(Tensor dummy) -> ()",
      c10::RegisterOperators::options().kernel<MockKernel>(
          c10::DispatchKey::CPUTensorId, &called_kernel_cpu));

  auto op = Dispatcher::singleton().findSchema({"_test::dummy", ""});
  ASSERT_TRUE(op.has_value()); // assert schema is registered

  // Ensure that dispatcher doesn't take the dispatch key from the tensor but
  // from the direct argument instead.
  called_kernel_cpu = false;
  callOpUnboxedWithDispatchKey<void, Tensor>(
      *op,
      c10::DispatchKey::CPUTensorId,
      ...
      [&] {
        callOpUnboxedWithDispatchKey<void, Tensor>(
            *op,
            ...
            dummyTensor(c10::DispatchKey::CPUTensorId));
      },
      "Could not run '_test::dummy' with arguments from the 'CUDATensorId'"
...
TEST(
  ...
  bool called_kernel1 = false;
  bool called_kernel2 = false;
  auto registrar0 = c10::RegisterOperators().op(
      "_test::dummy(Tensor dummy) -> ()",
      c10::RegisterOperators::options()
  ...
  // also assert that the error message contains the available tensor type ids,
  // but don't assert their order
  expectThrows<c10::Error>(
      [&] { callOp(*op, dummyTensor(c10::DispatchKey::XLATensorId)); },
      "CPUTensorId");
  expectThrows<c10::Error>(
...
TEST(
    OperatorRegistrationTest,
    whenRegisteringMultipleKernelsInSameOpCallOutOfScopeAndCalling_thenFails) {
  auto registrar0 =
      c10::RegisterOperators().op("_test::dummy(Tensor dummy) -> ()");
  {
    bool called_kernel1 = false;
    ...
    auto registrar1 = c10::RegisterOperators().op(
        ...
        c10::RegisterOperators::options()
            .kernel<MockKernel>(c10::DispatchKey::CPUTensorId, &called_kernel1)
            .kernel<MockKernel>(
                c10::DispatchKey::CUDATensorId, &called_kernel2));
  }
      ...
      [&] {
        auto registrar1 = c10::RegisterOperators().op(
            ...
            c10::RegisterOperators::options()
                ...
                .kernel<MockKernel>(
                    c10::DispatchKey::CUDATensorId, &called_kernel));
      },
...
TEST(
  ...
  auto registrar = c10::Dispatcher::singleton().registerFallback(
      c10::DispatchKey::CPUTensorId,
      c10::KernelFunction::makeFromBoxedFunction<&backend_fallback_kernel>());

  auto registrar1 = c10::RegisterOperators().op(
      "_test::dummy(Tensor dummy, str input) -> ()");
  auto op = Dispatcher::singleton().findSchema({"_test::dummy", ""});
  ASSERT_TRUE(op.has_value());
  auto stack =
      callOp(*op, dummyTensor(c10::DispatchKey::CPUTensorId), "hello ");
...
TEST(
  ...
  auto registrar1 = c10::RegisterOperators().op(
      "_test::dummy(Tensor dummy, str input) -> ()",
      c10::RegisterOperators::options().kernel(
          c10::DispatchKey::CUDATensorId,
          [](Tensor, std::string) { called = true; }));
  auto op = Dispatcher::singleton().findSchema({"_test::dummy", ""});
  ASSERT_TRUE(op.has_value());

  called = false;
  auto stack =
      callOp(*op, dummyTensor(c10::DispatchKey::CUDATensorId), "hello ");
  EXPECT_TRUE(called);
}
...
TEST(
  ...
  auto registrar = c10::RegisterOperators().op(
      "_test::dummy(Tensor dummy) -> ()",
      c10::RegisterOperators::options()
          .impl_unboxedOnlyKernel<decltype(autograd_kernel), &autograd_kernel>(
  ...
  c10::Dispatcher::singleton().callUnboxed<void, Tensor>(
      *op, dummyTensor(DispatchKey::CPUTensorId)); // note: all tensors have
                                                   // VariableTypeId set
  ...
  auto registrar = c10::RegisterOperators().op(
      ...
      c10::RegisterOperators::options()
          .impl_unboxedOnlyKernel<
              decltype(nonautograd_kernel),
              nonautograd_kernel>(DispatchKey::CPUTensorId)
          .impl_unboxedOnlyKernel<decltype(autograd_kernel), &autograd_kernel>(
              DispatchKey::VariableTensorId));
...
TEST(
  ...
  c10::Dispatcher::singleton().callUnboxed<void, Tensor>(
      *op, dummyTensor(DispatchKey::CPUTensorId));
...
TEST(
  ...
  auto registrar = c10::RegisterOperators().op(
      "_test::dummy(Tensor dummy) -> ()",
      c10::RegisterOperators::options()
          .impl_unboxedOnlyCatchAllKernel<
              decltype(nonautograd_kernel),
              nonautograd_kernel>()
          .impl_unboxedOnlyKernel<decltype(autograd_kernel), &autograd_kernel>(
              DispatchKey::VariableTensorId));
...
TEST(OperatorRegistrationTest, xlaPreAutogradOverridesAutogradKernel) {
  auto registrar = c10::RegisterOperators().op(
      ...
      c10::RegisterOperators::options()
          .impl_unboxedOnlyKernel<
              decltype(nonautograd_kernel),
              &nonautograd_kernel>(DispatchKey::XLAPreAutograd)
          .impl_unboxedOnlyKernel<decltype(autograd_kernel), &autograd_kernel>(
              DispatchKey::VariableTensorId));
  ...
  c10::Dispatcher::singleton().callUnboxed<void, Tensor>(
      *op,
      dummyTensor(c10::DispatchKeySet{DispatchKey::XLATensorId,
 ...
 *
 * Call ArgTypeTestKernel<Input, Output>::test(input, inputExpectation, output,
 * outputExpectation, schema) to test that a kernel with `Input` as input type
 * and `Output` as output types, when called with `input` fulfills
 * `inputExpectation` inside the kernel, then returns `output` and the returned
 * value fulfills `outputExpectation`.
 *
 * `inputExpectation` and `outputExpectation` should be lambdas that run
 * googletest expect macros (or use other ways to assert the expectation is
 * met).
 *
...
struct ArgTypeTestKernel final : OperatorKernel {
  explicit ArgTypeTestKernel(
      InputType input,
      std::function<void(const InputType&)> inputExpectation,
      OutputType output)
      : input_(std::move(input)),
        inputExpectation_(std::move(inputExpectation)),
  ...
  static void test(
      ...
      std::function<void(const InputType&)> inputExpectation,
      OutputType output,
      std::function<void(const c10::Stack&)> outputExpectation,
  ...
  static void test(
    ...
    return test_(
        [&] {
          return c10::RegisterOperators().op(
              "_test::my_op" + schema,
              c10::RegisterOperators::options()
                  .catchAllKernel<ArgTypeTestKernel>(
                      input, inputExpectation, output));
        },
        input,
        inputExpectation,
        output,
  ...
  static void test(
    ...
    return test_(
        [&] {
          return c10::RegisterOperators().op(
              "_test::my_op" + schema, [=](InputType input) -> OutputType {
 ...
 private:
  static void test_(
      std::function<c10::RegisterOperators()> registration,
      InputType input,
      std::function<void(const InputType&)> inputExpectation,
      OutputType output,
      std::function<void(const c10::Stack&)> outputExpectation,
...
struct testArgTypes final {
  ...
  static void test(
      ...
      std::function<void(const InputType&)> inputExpectation,
      OutputType output,
      std::function<void(const IValue&)> outputExpectation,
      const std::string& schema) {
    ...
    ArgTypeTestKernel<InputType, std::tuple<int64_t, OutputType>>::test(
        ...
        input,
        inputExpectation,
        std::tuple<int64_t, OutputType>{3, output},
        [&](const c10::Stack& output) {
...
TEST(OperatorRegistrationTest, testAvailableArgTypes) {
  ...
  testArgTypes<double>::test(
      1.5,
      [](const double& v) { EXPECT_EQ(1.5, v); },
      2.5,
      [](const IValue& v) { EXPECT_EQ(2.5, v.toDouble()); },
      "(float a) -> float");
  testArgTypes<int64_t>::test(
      1,
      [](const int64_t& v) { EXPECT_EQ(1, v); },
      2,
      [](const IValue& v) { EXPECT_EQ(2, v.toInt()); },
      "(int a) -> int");
  testArgTypes<bool>::test(
      true,
      [](const bool& v) { EXPECT_EQ(true, v); },
      false,
      [](const IValue& v) { EXPECT_EQ(false, v.toBool()); },
      "(bool a) -> bool");
  testArgTypes<bool>::test(
      false,
      [](const bool& v) { EXPECT_EQ(false, v); },
      true,
      [](const IValue& v) { EXPECT_EQ(true, v.toBool()); },
      "(bool a) -> bool");
  testArgTypes<std::string>::test(
      "string1",
      [](const std::string& v) { EXPECT_EQ("string1", v); },
      "string2",
      [](const IValue& v) { EXPECT_EQ("string2", v.toString()->string()); },
      "(str a) -> str");
  testArgTypes<Tensor>::test(
      dummyTensor(c10::DispatchKey::CPUTensorId),
      [](const Tensor& v) {
        EXPECT_EQ(c10::DispatchKey::CPUTensorId, extractDispatchKey(v));
      },
      dummyTensor(c10::DispatchKey::CUDATensorId),
      [](const IValue& v) {
        EXPECT_EQ(
            c10::DispatchKey::CUDATensorId, extractDispatchKey(v.toTensor()));
      },
      "(Tensor a) -> Tensor");

  // optional types (with has_value() == true)
  testArgTypes<c10::optional<double>>::test(
      c10::optional<double>(1.5),
      [](const c10::optional<double>& v) { EXPECT_EQ(1.5, v.value()); },
      c10::optional<double>(2.5),
      [](const IValue& v) { EXPECT_EQ(2.5, v.toDouble()); },
      "(float? a) -> float?");
  testArgTypes<c10::optional<int64_t>>::test(
      c10::optional<int64_t>(1),
      [](const c10::optional<int64_t>& v) { EXPECT_EQ(1, v.value()); },
      c10::optional<int64_t>(2),
      [](const IValue& v) { EXPECT_EQ(2, v.toInt()); },
      "(int? a) -> int?");
  testArgTypes<c10::optional<bool>>::test(
      c10::optional<bool>(true),
      [](const c10::optional<bool>& v) { EXPECT_EQ(true, v.value()); },
      c10::optional<bool>(false),
      [](const IValue& v) { EXPECT_EQ(false, v.toBool()); },
      "(bool? a) -> bool?");
  testArgTypes<c10::optional<bool>>::test(
      c10::optional<bool>(false),
      [](const c10::optional<bool>& v) { EXPECT_EQ(false, v.value()); },
      c10::optional<bool>(true),
      [](const IValue& v) { EXPECT_EQ(true, v.toBool()); },
      "(bool? a) -> bool?");
  testArgTypes<c10::optional<std::string>>::test(
      c10::optional<std::string>("string1"),
      [](const c10::optional<std::string>& v) {
        EXPECT_EQ("string1", v.value());
      },
      c10::optional<std::string>("string2"),
      [](const IValue& v) { EXPECT_EQ("string2", v.toString()->string()); },
      "(str? a) -> str?");
  testArgTypes<c10::optional<Tensor>>::test(
      c10::optional<Tensor>(dummyTensor(c10::DispatchKey::CPUTensorId)),
      [](const c10::optional<Tensor>& v) {
        EXPECT_EQ(c10::DispatchKey::CPUTensorId, extractDispatchKey(v.value()));
      },
      c10::optional<Tensor>(dummyTensor(c10::DispatchKey::CUDATensorId)),
      [](const IValue& v) {
        EXPECT_EQ(
            c10::DispatchKey::CUDATensorId, extractDispatchKey(v.toTensor()));
      },
  ...
  testArgTypes<c10::optional<double>>::test(
      c10::optional<double>(c10::nullopt),
      [](const c10::optional<double>& v) { EXPECT_FALSE(v.has_value()); },
      c10::optional<double>(c10::nullopt),
      [](const IValue& v) { EXPECT_TRUE(v.isNone()); },
      "(float? a) -> float?");
  testArgTypes<c10::optional<int64_t>>::test(
      c10::optional<int64_t>(c10::nullopt),
      [](const c10::optional<int64_t>& v) { EXPECT_FALSE(v.has_value()); },
      c10::optional<int64_t>(c10::nullopt),
      [](const IValue& v) { EXPECT_TRUE(v.isNone()); },
      "(int? a) -> int?");
  testArgTypes<c10::optional<bool>>::test(
      c10::optional<bool>(c10::nullopt),
      [](const c10::optional<bool>& v) { EXPECT_FALSE(v.has_value()); },
      c10::optional<bool>(c10::nullopt),
      [](const IValue& v) { EXPECT_TRUE(v.isNone()); },
      "(bool? a) -> bool?");
  testArgTypes<c10::optional<bool>>::test(
  ...
  testArgTypes<c10::optional<std::string>>::test(
      ...
      [](const c10::optional<std::string>& v) { EXPECT_FALSE(v.has_value()); },
      c10::optional<std::string>(c10::nullopt),
      [](const IValue& v) { EXPECT_TRUE(v.isNone()); },
      "(str? a) -> str?");
  testArgTypes<c10::optional<Tensor>>::test(
      c10::optional<Tensor>(c10::nullopt),
      [](const c10::optional<Tensor>& v) { EXPECT_FALSE(v.has_value()); },
      c10::optional<Tensor>(c10::nullopt),
      [](const IValue& v) { EXPECT_TRUE(v.isNone()); },
      "(Tensor? a) -> Tensor?");
  ...
  testArgTypes<c10::List<double>>::test(
      c10::List<double>({1.5, 2.5}),
      [](const c10::List<double>& v) {
        expectListEquals({1.5, 2.5}, v);
      },
      c10::List<double>({3.5, 4.5}),
      [](const IValue& v) {
        expectListEquals({3.5, 4.5}, v.to<c10::List<double>>());
      },
      "(float[] a) -> float[]");
  testArgTypes<c10::List<int64_t>>::test(
      c10::List<int64_t>({1, 2}),
      [](const c10::List<int64_t>& v) {
        expectListEquals({1, 2}, v);
      },
      c10::List<int64_t>({3, 4}),
      [](const IValue& v) {
        expectListEquals({3, 4}, v.to<c10::List<int64_t>>());
      },
      "(int[] a) -> int[]");
  testArgTypes<c10::List<bool>>::test(
      c10::List<bool>({true, false}),
      [](const c10::List<bool>& v) {
        expectListEquals({true, false}, v);
      },
      c10::List<bool>({true, false}),
      [](const IValue& v) {
        expectListEquals({true, false}, v.to<c10::List<bool>>());
      },
      "(bool[] a) -> bool[]");
  testArgTypes<c10::List<std::string>>::test(
      c10::List<std::string>({"first", "second"}),
      [](const c10::List<std::string>& v) {
        expectListEquals({"first", "second"}, v);
      },
      c10::List<std::string>({"first", "second"}),
      [](const IValue& v) {
  ...
  testArgTypes<c10::List<Tensor>>::test(
      c10::List<Tensor>({dummyTensor(c10::DispatchKey::CPUTensorId),
                         dummyTensor(c10::DispatchKey::CUDATensorId)}),
      [](const c10::List<Tensor>& v) {
        EXPECT_EQ(2, v.size());
      ...
      c10::List<Tensor>({dummyTensor(c10::DispatchKey::CUDATensorId),
                         dummyTensor(c10::DispatchKey::CPUTensorId)}),
      [](const IValue& v) {
        EXPECT_EQ(2, v.to<c10::List<at::Tensor>>().size());
        EXPECT_EQ(
            c10::DispatchKey::CUDATensorId,
            extractDispatchKey(v.to<c10::List<at::Tensor>>().get(0)));
        EXPECT_EQ(
            c10::DispatchKey::CPUTensorId,
            extractDispatchKey(v.to<c10::List<at::Tensor>>().get(1)));
      },
      "(Tensor[] a) -> Tensor[]");
  ...
  testArgTypes<std::vector<int64_t>, std::vector<int64_t>>::test<TestLegacyAPI>(
      std::vector<int64_t>(),
      [](const std::vector<int64_t>& v) { EXPECT_EQ(0, v.size()); },
      std::vector<int64_t>(),
      [](const IValue& v) { EXPECT_EQ(0, v.to<c10::List<int64_t>>().size()); },
      "(int[] a) -> int[]");
  ...
  testArgTypes<std::vector<Tensor>>::test<TestLegacyAPI>(
      std::vector<Tensor>({dummyTensor(c10::DispatchKey::CPUTensorId),
                           dummyTensor(c10::DispatchKey::CUDATensorId)}),
      ...
      std::vector<Tensor>({dummyTensor(c10::DispatchKey::CUDATensorId),
                           dummyTensor(c10::DispatchKey::CPUTensorId)}),
      [](const IValue& v) {
        EXPECT_EQ(2, v.to<c10::List<at::Tensor>>().size());
        EXPECT_EQ(
  ...
  testArgTypes<c10::optional<c10::List<int64_t>>>::test(
      c10::optional<c10::List<int64_t>>(c10::nullopt),
      [](const c10::optional<c10::List<int64_t>>& v) {
  ...
  testArgTypes<c10::optional<c10::List<int64_t>>>::test(
      c10::optional<c10::List<int64_t>>(c10::List<int64_t>({})),
      [](const c10::optional<c10::List<int64_t>>& v) {
        EXPECT_EQ(0, v.value().size());
      },
      c10::optional<c10::List<int64_t>>(c10::List<int64_t>({})),
      [](const IValue& v) { EXPECT_EQ(0, v.to<c10::List<int64_t>>().size()); },
      "(int[]? a) -> int[]?");
  ...
  testArgTypes<c10::optional<c10::List<int64_t>>>::test(
      c10::optional<c10::List<int64_t>>(c10::List<int64_t>({1, 2})),
      [](const c10::optional<c10::List<int64_t>>& v) {
        expectListEquals({1, 2}, v.value());
      },
      c10::optional<c10::List<int64_t>>(c10::List<int64_t>({3, 4})),
      [](const IValue& v) {
        expectListEquals({3, 4}, v.to<c10::List<int64_t>>());
      },
      "(int[]? a) -> int[]?");
  ...
  testArgTypes<c10::List<c10::optional<int64_t>>>::test(
      c10::List<c10::optional<int64_t>>(c10::List<c10::optional<int64_t>>({})),
      [](const c10::List<c10::optional<int64_t>>& v) {
        EXPECT_EQ(0, v.size());
      },
      c10::List<c10::optional<int64_t>>(c10::List<c10::optional<int64_t>>({})),
      [](const IValue& v) {
        EXPECT_EQ(0, v.to<c10::List<c10::optional<int64_t>>>().size());
      },
      "(int?[] a) -> int?[]");

  // Test list of optional (with values)
  testArgTypes<c10::List<c10::optional<int64_t>>>::test(
      c10::List<c10::optional<int64_t>>(
          c10::List<c10::optional<int64_t>>({3, c10::nullopt, 2})),
      [](const c10::List<c10::optional<int64_t>>& v) {
        expectListEquals<c10::optional<int64_t>>({3, c10::nullopt, 2}, v);
      },
      c10::List<c10::optional<int64_t>>(
          c10::List<c10::optional<int64_t>>({3, c10::nullopt, 2})),
      [](const IValue& v) {
        expectListEquals<c10::optional<int64_t>>(
            {3, c10::nullopt, 2}, v.to<c10::List<c10::optional<int64_t>>>());
      },
      "(int?[] a) -> int?[]");
  ...
  testArgTypes<c10::Dict<std::string, std::string>>::test(
      ...
      [](const IValue& v) {
        c10::Dict<std::string, std::string> dict =
            c10::impl::toTypedDict<std::string, std::string>(v.toGenericDict());
  ...
  testArgTypes<c10::Dict<int64_t, Tensor>>::test(
      ...
      tensor_dict,
      [](const IValue& v) {
        c10::Dict<int64_t, Tensor> dict =
            c10::impl::toTypedDict<int64_t, Tensor>(v.toGenericDict());
        EXPECT_EQ(2, dict.size());
        EXPECT_EQ(
            c10::DispatchKey::CPUTensorId, extractDispatchKey(dict.at(1)));
        EXPECT_EQ(
            c10::DispatchKey::CUDATensorId, extractDispatchKey(dict.at(2)));
      },
  ...
  testArgTypes<std::unordered_map<std::string, std::string>>::test<
      TestLegacyAPI>(
      str_map,
  ...
  testArgTypes<std::unordered_map<int64_t, Tensor>>::test<TestLegacyAPI>(
      tensor_map,
      [](std::unordered_map<int64_t, Tensor> v) {
        EXPECT_EQ(2, v.size());
        EXPECT_EQ(c10::DispatchKey::CPUTensorId, extractDispatchKey(v.at(1)));
        EXPECT_EQ(c10::DispatchKey::CUDATensorId, extractDispatchKey(v.at(2)));
      },
  ...
  using DeeplyNestedType = c10::List<c10::Dict<
      std::string,
      c10::List<c10::optional<c10::Dict<int64_t, std::string>>>>>;
  ...
  testArgTypes<DeeplyNestedType>::test(
      ...
      [](const DeeplyNestedType& v) {
        EXPECT_EQ("1", v.get(0).at("key").get(0).value().at(1));
      },
      makeDeeplyNestedObject(),
      [](const IValue& v) {
        EXPECT_EQ(
            "1",
            v.to<DeeplyNestedType>().get(0).at("key").get(0).value().at(1));
      },
...
TEST(NewOperatorRegistrationTest, testBasics) {
  auto registrar =
      c10::import()
          ...
          .def(
              "_test::dummy3(Tensor self, Tensor other) -> Tensor",
              [](const Tensor& self, const Tensor& other) { return self; })
          .def(
              "_test::dummy4",
              [](const Tensor& self, const Tensor& other) { return other; })
          .impl(
              "_test::dummy",
              c10::DeviceType::CPU,
              [](const Tensor& self) { return self; })
          .impl(
              "_test::dummy",
              c10::DeviceType::XLA,
              [](const Tensor& self) { return self; })
  ...
  ASSERT_TRUE(
      Dispatcher::singleton().findSchema({"_test::dummy", ""}).has_value());
  // Should have a schema even if there are no impls
  ASSERT_TRUE(
      Dispatcher::singleton().findSchema({"_test::dummy1", ""}).has_value());
  ASSERT_TRUE(
      Dispatcher::singleton().findSchema({"_test::dummy2", ""}).has_value());
  ASSERT_TRUE(
      Dispatcher::singleton().findSchema({"_test::dummy3", ""}).has_value());
  ASSERT_TRUE(
      Dispatcher::singleton().findSchema({"_test::dummy4", ""}).has_value());
}
...
TEST(NewOperatorRegistrationTest, importTopLevel) {
  auto registrar = c10::import()
                       ...
                       .def(
                           "test::def2(Tensor self) -> Tensor",
                           [](const Tensor& x) { return x; })
                       .def("test::def3", [](const Tensor& x) { return x; })
                       .impl("test::impl1", [](const Tensor& x) { return x; });
  ASSERT_TRUE(
      Dispatcher::singleton().findSchema({"test::def1", ""}).has_value());
  ASSERT_TRUE(
      Dispatcher::singleton().findSchema({"test::def2", ""}).has_value());
  ASSERT_TRUE(
      Dispatcher::singleton().findSchema({"test::def3", ""}).has_value());
...
TEST(NewOperatorRegistrationTest, overload) {
  auto registrar =
      c10::import()
          ...
          .def(
              "test::fn.overload2(Tensor self, Tensor other, Tensor alpha) -> Tensor");
  ASSERT_TRUE(Dispatcher::singleton().findSchema({"test::fn", ""}).has_value());
  ASSERT_TRUE(Dispatcher::singleton()
                  .findSchema({"test::fn", "overload1"})
                  .has_value());
  ASSERT_TRUE(Dispatcher::singleton()
                  .findSchema({"test::fn", "overload2"})
                  .has_value());
}
...
TEST(NewOperatorRegistrationTest, importNamespace) {
  auto registrar =
      c10::_import_DOES_NOT_WORK_WITH_MOBILE_CUSTOM_BUILD("test")
          ...
          .def(
              "retest::def2(Tensor self) -> Tensor",
              [](const Tensor& x) { return x; })
  ...
  ASSERT_TRUE(Dispatcher::singleton().findOp({"test::impl1", ""}).has_value());
  ASSERT_TRUE(
      Dispatcher::singleton().findSchema({"retest::def1", ""}).has_value());
  ASSERT_TRUE(
      Dispatcher::singleton().findSchema({"retest::def2", ""}).has_value());
  ASSERT_TRUE(
      Dispatcher::singleton().findSchema({"retest::def3", ""}).has_value());
  ASSERT_TRUE(
      Dispatcher::singleton().findOp({"retest::impl1", ""}).has_value());
}
...
TEST(NewOperatorRegistrationTest, schema) {
  ...
  ASSERT_TRUE(
      Dispatcher::singleton().findSchema({"test::def3", ""}).has_value());
  ASSERT_TRUE(
      Dispatcher::singleton().findSchema({"test::def4", ""}).has_value());

  EXPECT_EQ(
      Dispatcher::singleton()
          .findSchema({"test::def1", ""})
          ->schema()
          .aliasAnalysis(),
      c10::AliasAnalysisKind::FROM_SCHEMA);
  EXPECT_EQ(
      Dispatcher::singleton()
          .findSchema({"test::def2", ""})
          ->schema()
          .aliasAnalysis(),
      c10::AliasAnalysisKind::FROM_SCHEMA);
  EXPECT_EQ(
      Dispatcher::singleton()
          .findSchema({"test::def3", ""})
          ->schema()
          .aliasAnalysis(),
      c10::AliasAnalysisKind::PURE_FUNCTION);
  ASSERT_TRUE(Dispatcher::singleton()
                  .findSchema({"test::def4", ""})
                  ->schema()
...
TEST(NewOperatorRegistrationTest, dispatch) {
  ...
  auto registrar =
      c10::import()
          ...
          .def(
              "test::fn_autograd",
              torch::dispatch(c10::kAutograd, [&](const Tensor& x) {
                autograd_called = true;
                return x;
              }));
...
TEST(NewOperatorRegistrationTest, dispatchMultiple) {
  ...
  auto registrar = c10::import()
                       .def("test::fn(Tensor self) -> Tensor")
                       // NB: Direct use of DispatchKey is discouraged; use the
                       // DeviceType k-synonyms instead
                       .impl(
                           "test::fn",
                           c10::DispatchKey::CPUTensorId,
                           [&](const Tensor& x) {
                       ...
                       .impl("test::fn", c10::kAutograd, [&](const Tensor& x) {
                         autograd_called = true;
                         return x;
                       });
...
TEST(NewOperatorRegistrationTest, fallback) {
  auto registrar = c10::import().fallback(
      c10::kCPU,
      c10::CppFunction::makeFromBoxedFunction<&backend_fallback_kernel>());
                       ...
                       .impl(
                           ...
                           [&](const Tensor& x) {
                             ...
                             return c10::Dispatcher::singleton()
                                 .callUnboxedRedispatch<Tensor, const Tensor&>(
                                     *op, c10::DispatchKey::BackendSelect, x);
                           });
  auto op = Dispatcher::singleton().findSchema({"test::fn", ""});
  ASSERT_TRUE(op.has_value());
  callOp(*op, dummyTensor(c10::DispatchKey::CPUTensorId));
...
TEST(NewOperatorRegistrationTest, CppFunction) {
  ...
  auto registrar =
      c10::import()
          ...
          .def(
              "test::fn4(Tensor x) -> Tensor",
              c10::CppFunction::makeFallthrough())
          .def(
              "test::fn5(Tensor x) -> Tensor",
              c10::CppFunction::makeUnboxedOnly(dummy_fn))
          .def(
              "test::fn6(Tensor x) -> Tensor",
              c10::CppFunction::makeFromBoxedFunction<
                  &backend_fallback_kernel>());
}

// Some internal tests that have to be done from C++

struct OpRegistrationListenerForDelayedListenerTest
    : public c10::OpRegistrationListener {
...
TEST(NewOperatorRegistrationTest, testDelayedListener) {
  auto listener =
      std::make_unique<OpRegistrationListenerForDelayedListenerTest>();
  ...
  auto reg1 = c10::import().impl(
      "_test::dummy", [](const Tensor& self) { return self; });
...
TEST(OperatorRegistrationTest, whenDeregisteringOp_thenHandleBecomesInvalid) {
  ...
  {
    auto registrar = c10::import().def("_test::dummy(Tensor dummy) -> Tensor");
